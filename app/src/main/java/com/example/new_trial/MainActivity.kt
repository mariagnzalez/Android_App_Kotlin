...
import com.example.new_trial.BuildConfig
...
class MainActivity : AppCompatActivity() {
    ...
    private val scanResults = mutableListOf<ScanResult>() // hold our scan results
    ...
    private fun startBleScan() { //Scanning devices
    ...
    private val scanCallback = object : ScanCallback() { // notified that a BLE connection is avaible
